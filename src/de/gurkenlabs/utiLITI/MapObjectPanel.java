...
public class MapObjectPanel extends PropertyPanel<IMapObject> {
  ...
  private JTextField textFieldCustomType;
  ...
  public MapObjectPanel() {
    ...
    textFieldCustomType = new JTextField();
    textFieldCustomType.setColumns(10);
    textFieldCustomType.setVisible(false);
        ...
        groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(groupLayout.createSequentialGroup()
                .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                    .addGroup(groupLayout.createSequentialGroup()
                        .addGap(72)
                        .addComponent(textFieldCustomType, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE))
                    .addGroup(groupLayout.createSequentialGroup()
                        .addContainerGap()
                        ...
                        .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                            ...
                            .addGroup(groupLayout.createSequentialGroup()
                                .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                                    .addComponent(spinnerWidth, GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                                    .addComponent(spinnerX, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE))
                                ...
                                .addGap(0)
                                .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                                    .addComponent(spinnerY, GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
                                    .addComponent(spinnerHeight, GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)))
                            .addComponent(comboBoxType, 0, 167, Short.MAX_VALUE)
                            .addComponent(textFieldName, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE))))
                .addGap(6))
            .addComponent(componentPanel, GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE));
    groupLayout.setVerticalGroup(
        groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(groupLayout.createSequentialGroup()
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                    .addComponent(lblWidth, GroupLayout.PREFERRED_SIZE, 13, GroupLayout.PREFERRED_SIZE)
                    .addComponent(spinnerWidth, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblHeight, GroupLayout.PREFERRED_SIZE, 13, GroupLayout.PREFERRED_SIZE)
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(textFieldCustomType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(componentPanel, GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)));
  ...
  protected void clearControls() {
    ...
    this.textFieldCustomType.setText("");
  }
