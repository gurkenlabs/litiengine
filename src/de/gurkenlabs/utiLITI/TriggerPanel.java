...
public class TriggerPanel extends PropertyPanel<IMapObject> {
  ...
  JComboBox<String> comboBoxActivationType;
  ...
  public TriggerPanel() {
    ...
    comboBoxActivationType.setModel(new DefaultComboBoxModel(TriggerActivation.values()));
    ...
    button_2.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        targetsModel.addRow(new Object[] { 0 });
      }
    });
                    ...
                    .addGroup(groupLayout.createSequentialGroup()
                        ...
                        .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                            ...
                            .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
                                ...
                                .addComponent(button_2, GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE))
    ...
    scrollPane_1.setViewportView(tableTargets);
  ...
  protected void setControlValues(IMapObject mapObject) {
    ...
    final TriggerActivation act = mapObject.getCustomProperty(MapObjectProperties.TRIGGERACTIVATION) == null ? TriggerActivation.COLLISION : TriggerActivation.valueOf(mapObject.getCustomProperty(MapObjectProperties.TRIGGERACTIVATION));
  ...
  private void setupChangedListeners() {
    this.chckbxOneTimeOnly.addActionListener(new MapObjectPropertyActionListener(m -> {
      m.setCustomProperty(MapObjectProperties.TRIGGERONETIME, Boolean.toString(this.chckbxOneTimeOnly.isSelected()));
    }));

    this.textFieldMessage.addFocusListener(new MapObjectPropteryFocusListener(m -> {
      m.setCustomProperty(MapObjectProperties.TRIGGERMESSAGE, textFieldMessage.getText());
    }));

    this.textFieldMessage.addActionListener(new MapObjectPropertyActionListener(m -> {
      m.setCustomProperty(MapObjectProperties.TRIGGERMESSAGE, textFieldMessage.getText());
    }));
    ...
    this.comboBoxActivationType.addActionListener(new MapObjectPropertyActionListener(m -> {
      ...
      m.setCustomProperty(MapObjectProperties.TRIGGERACTIVATION, act.toString());
    }));
    ...
    this.model.addTableModelListener(new TableModelListener() {
      ...
      public void tableChanged(TableModelEvent e) {
        ...
        getDataSource().setCustomProperty(MapObjectProperties.TRIGGERACTIVATORS, String.join(",", activators));
      }
    });

    this.targetsModel.addTableModelListener(new TableModelListener() {
      ...
      public void tableChanged(TableModelEvent e) {
        ...
        getDataSource().setCustomProperty(MapObjectProperties.TRIGGERTARGETS, String.join(",", targets));
      }
    });
  }
}
