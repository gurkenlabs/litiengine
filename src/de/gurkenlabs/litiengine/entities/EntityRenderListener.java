...
/**
 * This listener interface is used for receiving events during an entity's rendering process from
 * the game's {@code RenderEngine}.
 *
...
public interface EntityRenderListener extends EntityRenderedListener {
   ...
   * the entity is about to be rendered.
   *
  ...
  /**
   * This method gets called before an {@code Entity} is about to be rendered. Returning false
   * prevents the rendering of the specified entity.
   *
