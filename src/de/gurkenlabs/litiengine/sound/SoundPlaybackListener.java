...
/**
 * This event listener implementation provides callbacks for when a {@link SoundPlayback} instance
 * gets cancelled or finished.
 */
public interface SoundPlaybackListener extends EventListener {
   ...
   *
   * @param event a {@link SoundEvent} object describing the event source and the related {@link
   *     Sound}.
   */
