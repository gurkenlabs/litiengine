...
public class StaticShadowMapObjectLoader extends MapObjectLoader {
  ...
  public Collection<IEntity> load(IEnvironment environment, IMapObject mapObject) {
    ...
    StaticShadowType type = mapObject.getEnum(MapObjectProperty.SHADOW_TYPE, StaticShadowType.class, StaticShadowType.DOWN);
    int offset = mapObject.getInt(MapObjectProperty.SHADOW_OFFSET, StaticShadow.DEFAULT_OFFSET);
