...
/**
 * The Class MessageType defines a static struct which contains all possible message types for network communication.
 * Some types are litiengine default.
 * If you need to create different messages you should use message ids in the range between 20 and 127;
 * Also see TODO(wiki) for more details.
 */
