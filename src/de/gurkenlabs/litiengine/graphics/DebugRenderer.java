...
public class DebugRenderer {
  ...
  private static void drawMapId(final Graphics2D g, final IEntity entity) {
    ...
    TextRenderer.drawText(g, Integer.toString(entity.getMapId()), x, y);
    ...
    TextRenderer.drawText(g, locationString, x, y + 5.0);
  }
  ...
  private static void drawTileBoundingBox(final Graphics2D g, final IMap map, final Point2D location) {
    ...
    TextRenderer.drawText(g, locationText, (float) (relative.getX() + playerTile.getWidth() + 3), (float) (relative.getY() + fm.getHeight()));
    ...
    TextRenderer.drawText(g, sb.toString(), (float) (relative.getX() + playerTile.getWidth() + 3), (float) (relative.getY() + fm.getHeight() * 2 + 2));
  }
}
