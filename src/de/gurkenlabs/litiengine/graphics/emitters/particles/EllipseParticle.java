...
public class EllipseParticle extends ShapeParticle {
  ...
  public EllipseParticle(final float width, final float height, final Color color) {
  ...
  protected Shape getShape(final Point2D emitterOrigin) {
    ...
    return rotate.createTransformedShape(new Ellipse2D.Float(this.getAbsoluteX(emitterOrigin), this.getAbsoluteY(emitterOrigin), this.getWidth(), this.getHeight()));
  }
}
