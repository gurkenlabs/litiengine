...
public class LeftLineParticle extends Particle {
  ...
  public LeftLineParticle(final float xCurrent, final float yCurrent, final float dx, final float dy, final float gravityX, final float gravityY, final byte width, final byte height, final int life, final Color color) {
