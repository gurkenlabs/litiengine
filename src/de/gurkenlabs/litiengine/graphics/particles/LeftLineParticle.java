...
public class LeftLineParticle extends Particle {
 ...
 RenderEngine.drawShape(g,new Line2D.Double(renderLocation.getX() + this.getWidth(), renderLocation.getY(), renderLocation.getX(), renderLocation.getY() + this.getHeight()));
  }
}
