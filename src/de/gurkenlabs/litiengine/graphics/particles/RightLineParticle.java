...
public class RightLineParticle extends Particle {
  ...
  public void render(final Graphics2D g, final Point2D emitterOrigin) {
    ...
    RenderEngine.drawShape(g,new Line2D.Double(renderLocation.getX(), renderLocation.getY(), renderLocation.getX() + this.getWidth(), renderLocation.getY() + this.getHeight()));
  }
}
