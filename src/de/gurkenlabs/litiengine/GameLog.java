...
/**
 * The {@code GameLog} class provides a general purpose logger for games. It prevents the necessity
 * to create custom logger instances and provides a simplified way to quickly log events.
 *
 * @see Game#log()
 */
final class GameLog {
