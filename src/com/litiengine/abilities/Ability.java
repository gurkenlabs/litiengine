...
import com.litiengine.entities.EntityPivot;
...
public abstract class Ability implements IRenderable {
  ...
  public void onEffectApplied(final Effect.EffectAppliedListener listener) {
  ...
  public void onEffectCeased(final Effect.EffectCeasedListener listener) {
    for (final Effect effect : this.getEffects()) {
      // registers to all effects and their follow up effects recursively
  ...
  private void onEffectApplied(final Effect effect, final Effect.EffectAppliedListener listener) {
  ...
  private void onEffectCeased(final Effect effect, final Effect.EffectCeasedListener listener) {
