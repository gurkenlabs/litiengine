...
public final class Imaging {
   ...
   *          <ul>
   *          <li>{@link Imaging#CROP_ALIGN_CENTER
   *          CROP_ALIGN_CENTER}</li>
   *          <li>{@link Imaging#CROP_ALIGN_LEFT
   *          CROP_ALIGN_LEFT}</li>
   *          <li>{@link Imaging#CROP_ALIGN_RIGHT
   *          CROP_ALIGN_RIGHT}</li>
   *          </ul>
   * @param cropVerticlaAlignment
   *          use the following consts: <br>
   *          <ul>
   *          <li>{@link Imaging#CROP_VALIGN_CENTER
   *          CROP_VALIGN_CENTER}</li>
   *          <li>{@link Imaging#CROP_VALIGN_TOP
   *          CROP_VALIGN_TOP}</li>
   *          <li>{@link Imaging#CROP_VALIGN_TOPCENTER
   *          CROP_VALIGN_TOPCENTER}</li>
   *          <li>{@link Imaging#CROP_VALIGN_BOTTOM
