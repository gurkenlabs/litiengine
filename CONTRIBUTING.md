...
* Install JDK 25. LITIENGINE uses it as the build toolchain and minimum supported runtime.
...
* Make sure that JDK 25 is available to Gradle and configured as your Gradle runtime.
