...
class RangeAttributeTest {
  ...
  void testModifyBaseValue() {
    ...
    testRangeAttributeByte.modifyBaseValue(new AttributeModifier<>(Modification.ADD, (byte) 10));
    testRangeAttributeShort.modifyBaseValue(new AttributeModifier<>(Modification.ADD, (short) 100));
    testRangeAttributeInt.modifyBaseValue(new AttributeModifier<>(Modification.ADD, 100));
    testRangeAttributeLong.modifyBaseValue(new AttributeModifier<>(Modification.ADD, 1000L));
    testRangeAttributeFloat.modifyBaseValue(new AttributeModifier<>(Modification.ADD, 101.1f));
    testRangeAttributeDouble.modifyBaseValue(new AttributeModifier<>(Modification.ADD, 101.1));
    ...
    assertEquals(111.1f, testRangeAttributeFloat.get(), 0.0001f);
    assertEquals(111.1, testRangeAttributeDouble.get(), 0.0000001);
  }
}
