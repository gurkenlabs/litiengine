 ...
 */
public class PropertyModifier<T extends Number> implements Comparable<PropertyModifier<T>> {
   ...
   */
  public PropertyModifier(final Modification mod, final double modifyValue) {
   ...
   */
  @Override
  public int compareTo(final PropertyModifier<T> otherModifier) {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof PropertyModifier<?> am) {
