...
public interface ICustomPropertyProvider {
   ...
   * @throws NoSuchElementException if the custom property does not exist
   * @throws NumberFormatException  if the custom property is not an integer or is out of range for
   *                                a {@code short}
   */
  ...
  Number getNumber(String propertyName, Number defaultValue);
  ...
  /**
   * Sets the value for the custom property with the given name to the given Number.
   *
   * @param propertyName the name of the custom property
   * @param value        the new value
   */
  void setValue(String propertyName, Number value);
