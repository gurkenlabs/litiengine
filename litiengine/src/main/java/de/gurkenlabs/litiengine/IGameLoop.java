...
public interface IGameLoop extends ILoop {
   ...
   * @param action The action to perform, once the delay has passed.
   * @return The id of the {@code TimedAction} that can be used to alter the execution time of the
   *     action or remove it.
   ...
   * This overwrites the originally specified delay.
   *
   * @param id The id of the {@code TimedAction}.
   * @param tick The tick at which to perform the action instead.
   */
   ...
   *
   * <p>This can be used to fast-forward the gameplay or to introduce slow-motion effects.
   *
