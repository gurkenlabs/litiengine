...
public class TransformTests {
  ...
  public void testResizeTransform() {
    ...
    Rectangle2D down = Transform.ResizeAnchor.DOWN.getNewBounds(10, 10, 20, 20, 10, 10);
    ...
    Rectangle2D up = Transform.ResizeAnchor.UP.getNewBounds(10, -10, 20, 20, 10, 10);
    ...
    Rectangle2D left = Transform.ResizeAnchor.LEFT.getNewBounds(-10, 10, 20, 20, 10, 10);
    ...
    Rectangle2D right = Transform.ResizeAnchor.RIGHT.getNewBounds(10, 10, 20, 20, 10, 10);
    ...
    Rectangle2D downRight = Transform.ResizeAnchor.DOWNRIGHT.getNewBounds(10, 10, 20, 20, 10, 10);
    ...
    Rectangle2D downLeft = Transform.ResizeAnchor.DOWNLEFT.getNewBounds(-10, 10, 20, 20, 10, 10);
    ...
    Rectangle2D upRight = Transform.ResizeAnchor.UPRIGHT.getNewBounds(10, -10, 20, 20, 10, 10);
    ...
    Rectangle2D upLeft = Transform.ResizeAnchor.UPLEFT.getNewBounds(-10, -10, 20, 20, 10, 10);
  ...
  public void ensureThatResizeTransformDoesNotOvershoot() {
    Rectangle2D up = Transform.ResizeAnchor.UP.getNewBounds(10, 100, 20, 20, 10, 10);
    ...
    Rectangle2D upRight = Transform.ResizeAnchor.UPRIGHT.getNewBounds(10, 100, 20, 20, 10, 10);
    ...
    Rectangle2D upLeft = Transform.ResizeAnchor.UPLEFT.getNewBounds(-100, 100, 20, 20, 10, 10);
