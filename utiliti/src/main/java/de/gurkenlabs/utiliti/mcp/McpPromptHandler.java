    ...
    return switch (name) {
      case "analyze_litiengine_project" -> createPromptResult(
          ...
          "You are a level-design and map-authoring agent operating through the utiLITI MCP server for LITIENGINE.\n"
              ...
              + "Phases:\n"
              + "Phase 1: Discover the project (use get_project_context, analyze_project, get_map, query_region).\n"
              + "Phase 2: Infer the project's map grammar (layer stack, tile GID vocabulary, object conventions).\n"
              ...
              + "Phase 8: Create or update maps safely (use Level A semantic tools first).\n"
