...
public final class Icons {
  ...
  public static final Icon COLOR = new ImageIcon(Resources.images().get("button-color.png"));
  ...
  public static final Icon COPY = new ImageIcon(Resources.images().get("button-copy.png"));
  public static final Icon COPYX16 = new ImageIcon(Resources.images().get("button-copyx16.png"));
  public static final Icon CREATE = new ImageIcon(Resources.images().get("button-create.png"));
  ...
  public static final Icon CUT = new ImageIcon(Resources.images().get("button-cut.png"));
  ...
  public static final Icon LOAD = new ImageIcon(Resources.images().get("button-load.png"));
  ...
  public static final Icon MOVE = new ImageIcon(Resources.images().get("button-move.png"));
  public static final Icon PAUSE = new ImageIcon(Resources.images().get("button-pause.png"));
  public static final Icon PASTE = new ImageIcon(Resources.images().get("button-pastex16.png"));
  public static final Icon PASTEX16 = new ImageIcon(Resources.images().get("button-paste.png"));
  public static final Icon PENCIL = new ImageIcon(Resources.images().get("pencil.png"));
  public static final Icon PLACEOBJECT = new ImageIcon(Resources.images().get("button-placeobject.png"));
